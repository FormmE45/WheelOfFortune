...
//Participants
const participant1=new Participant(1,"NGUYỄN THỊ THÙY NGA",3,14,"HIGHEST",true)
const participant2=new Participant(2,"LÊ VĂN HẬN",3,14,"HIGHEST",true)
const participant3=new Participant(3,"PHẠM THỊ NHÂN HÒA",3,13,"HIGHEST",true)
const participant4=new Participant(4,"NGUYỄN PHÚC SƠN",3,13,"HIGHEST",true)
const participant5=new Participant(5,"NGUYỄN VĂN CHÍNH TRỰC",3,10,"HIGHEST",true)
const participant6=new Participant(6,"TÔN NỮ HUYỀN PHƯƠNG",2,8,"HIGHEST",true)
const participant7=new Participant(7,"VŨ THỊ TUYẾT MAI",2,8,"HIGHEST",true)
const participant8=new Participant(8,"NGUYỄN HOÀNG THẢO NGUYÊN",2,7,"HIGHEST",true)
const participant9=new Participant(9,"NGÔ ANH HÙNG",2,7,"HIGHEST",true)
const participant10=new Participant(10,"HUỲNH VIỆT KHƯƠNG",2,7,"HIGHEST",true)
const participant11=new Participant(11,"HOÀNG THỊ THU YẾN",2,7,"HIGHEST",true)
const participant12=new Participant(12,"NGUYỄN KHẮC CƯỜNG",2,7,"HIGHEST",true)
const participant13=new Participant(13,"PHAN THỊ NGỌC CHÂU",2,7,"HIGHEST",true)
const participant14=new Participant(14,"PHAN NỮ DANH PHƯƠNG",2,7,"HIGHEST",true)
const participant15=new Participant(15,"LÊ HỒNG SƠN",2,6,"HIGHEST",true)
const participant16=new Participant(16,"NGUYỄN THỊ THẢO NGUYÊN",2,5,"HIGHEST",true)
const participant17=new Participant(17,"BÙI THỊ HƯƠNG",2,5,"HIGHEST",true)
const participant18=new Participant(18,"BÙI THỊ THANH HÒA",2,5,"HIGHEST",true)
const participant19=new Participant(19,"NGUYỄN HOÀNG PHƯƠNG",2,5,"HIGHEST",true)
const participant20=new Participant(20,"NGUYỄN ĐÌNH SƠN",2,5,"HIGHEST",true)
const participant21=new Participant(21,"LÊ THỊ HỒNG PHÚ",2,5,"HIGHEST",true)
const participant22=new Participant(22,"BÙI THỊ HỒNG",2,5,"HIGHEST",true)
const participant23=new Participant(23,"PHAN THỊ NGỌC HUỆ",2,5,"HIGHEST",true)
const participant24=new Participant(24,"PHẠM LÂM THANH NHÃ",2,5,"HIGHEST",true)
const participant25=new Participant(25,"LÊ QUANG MINH",2,5,"HIGHEST",true)
const participant26=new Participant(26,"NGUYỄN THÀNH ĐẠT",2,5,"HIGHEST",true)
const participant27=new Participant(27,"BÙI THỊ NHƯ THẢO",2,5,"HIGHEST",true)
const participant28=new Participant(28,"NGUYỄN THỊ NGỌC TÚ",1,4,"HIGH",true)
const participant29=new Participant(29,"HUỲNH NGUYỄN THỦY THƯƠNG",1,4,"HIGH",true)
const participant30=new Participant(30,"PHẠM NGỌC TRẬN",1,3,"MID",true)
const participant31=new Participant(31,"NGUYỄN THỊ ÁNH HỒNG",1,3,"MID",true)
const participant32=new Participant(32,"NGUYỄN NHỰT MINH TUYỀN",1,3,"MID",true)
const participant33=new Participant(33,"NGÔ VĂN HIỆN",1,3,"MID",true)
const participant34=new Participant(34,"LÊ TIẾN DŨNG",1,3,"MID",true)
const participant35=new Participant(35,"PHAN MINH KHÁNH",1,3,"MID",true)
const participant36=new Participant(36,"NGUYỄN THANH TÙNG",1,3,"MID",true)
